...
const CATEGORY_OPTIONS = [
  { subCategory: 'school-learning', category: 'School & Learning', parentCat: 'Kids', subcatName: 'School & Learning', subcatLink: 'school-learning' },
  { subCategory: 'behavior-confidence', category: 'Behavior & Confidence', parentCat: 'Kids', subcatName: 'Behavior & Confidence', subcatLink: 'behavior-confidence' },
  { subCategory: 'health-nutrition', category: 'Health & Nutrition', parentCat: 'Kids', subcatName: 'Health & Nutrition', subcatLink: 'health-nutrition' },
  ...
  { subCategory: 'relationships', category: 'Relationships', parentCat: 'Family', subcatName: 'Relationships', subcatLink: 'relationships' },
  { subCategory: 'family-culture-values', category: 'Family Culture & Values', parentCat: 'Family', subcatName: 'Family Culture & Values', subcatLink: 'family-culture-values' },
  { subCategory: 'conflict-resolution', category: 'Conflict Resolution', parentCat: 'Family', subcatName: 'Conflict Resolution', subcatLink: 'conflict-resolution' },
  { subCategory: 'mental-health', category: 'Mental Health', parentCat: 'Health', subcatName: 'Mental Health', subcatLink: 'mental-health' },
  { subCategory: 'sleep-lifestyle', category: 'Sleep & Lifestyle', parentCat: 'Health', subcatName: 'Sleep & Lifestyle', subcatLink: 'sleep-lifestyle' },
  { subCategory: 'nutrition', category: 'Nutrition', parentCat: 'Health', subcatName: 'Nutrition', subcatLink: 'nutrition' },
