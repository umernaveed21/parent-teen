...
const CATEGORY_DICTIONARY = {
  'school-learning': { title: "School & Learning", parentCat: "Kids", description: "Nurturing curiosity, establishing foundational reading habits, and supporting your child's early primary school transitions." },
  'behavior-confidence': { title: "Behavior & Confidence", parentCat: "Kids", description: "Helping young children understand big emotions, grow strong self-esteem, and navigate early social circles." },
  'health-nutrition': { title: "Health & Nutrition", parentCat: "Kids", description: "Practical advice on balanced meals, physical development milestones, and healthy sleep routines for growing children." },
  ...
  'relationships': { title: "Relationships", parentCat: "Family", description: "Nurturing sibling connections, balancing extended family relationships, and maintaining strong domestic support networks." },
  'family-culture-values': { title: "Family Culture & Values", parentCat: "Family", description: "Creating warm traditions, passing down cultural values, and establishing a healthy household identity." },
  'conflict-resolution': { title: "Conflict Resolution", parentCat: "Family", description: "De-escalating everyday arguments, mediating family disputes, and maintaining long-term domestic harmony." },
  'mental-health': { title: "Mental Health", parentCat: "Health", description: "Recognizing stress and anxiety, building everyday emotional strength, and finding expert support avenues." },
  'sleep-lifestyle': { title: "Sleep & Lifestyle", parentCat: "Health", description: "Designing screen-free bedtime routines, managing physical fitness, and creating active daily structures." },
  'nutrition': { title: "Nutrition", parentCat: "Health", description: "Fueling rapid adolescent growth with nutrient-dense meal choices and promoting a positive relationship with food." },
