...
const CATEGORY_DICTIONARY = {
  ...
  'parenting-realities': { title: "Parenting Realities", parentCat: "Parenting", description: "Replacing friction with productive conversations, practicing deep active listening, and keeping communication channels open across the whole family." },
  ...
  'healthy-living-prevention': { title: "Healthy Living & Prevention", parentCat: "Health", description: "Designing screen-free routines, preventive care habits, and active daily structures that support long-term wellbeing." },
